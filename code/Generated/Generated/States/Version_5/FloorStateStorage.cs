...
namespace Version_5
{
    public static class FloorStateStorage
    {
        ...
        public static bool IsPre_spawned(GameObject obj) => stateTable[obj] == FloorStateEnum.Pre_spawned;
        public static bool IsReady(GameObject obj) => stateTable[obj] == FloorStateEnum.Ready;

        public static void SetPre_spawned(GameObject obj) => SetState(obj, FloorStateEnum.Pre_spawned);
