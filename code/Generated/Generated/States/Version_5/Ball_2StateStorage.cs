...
namespace Version_5
{
    public static class Ball_2StateStorage
    {
        ...
        public static bool IsDragging(GameObject obj) => stateTable[obj] == Ball_2StateEnum.Dragging;
        ...
        public static void SetDragging(GameObject obj) => SetState(obj, Ball_2StateEnum.Dragging);
