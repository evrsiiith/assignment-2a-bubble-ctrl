...
namespace Version_3
{
    public static class UserAlgorithms
    {
        ...
        {
            bool isOn = StateAccessor.IsState(obj.name, "on", obj, "Version_3");
            if (isOn)
            {
                ...
                StateAccessor.SetState(obj.name, "off", obj, "Version_3");
            ...
            else
            {
                ...
                StateAccessor.SetState(obj.name, "on", obj, "Version_3");
        ...
        public static void BounceBall(GameObject obj)
        {
            ...
            StateAccessor.SetState(obj.name, "bouncing", obj, "Version_3");
        ...
        {
            StateAccessor.SetState(obj.name, "resting", obj, "Version_3");
        }
        ...
        public static void CollectCoin(GameObject obj)
        {
            ...
            StateAccessor.SetState(obj.name, "collected", obj, "Version_3");
            obj.SetActive(false);
        }
        ...
        public static void OpenGate(GameObject obj)
        {
            ...
            StateAccessor.SetState("Gate", "unlocked", obj, "Version_3");
        }
        ...
        public static void PressButton(GameObject obj)
        {
            ...
            StateAccessor.SetState(obj.name, "pressed", obj, "Version_3");
